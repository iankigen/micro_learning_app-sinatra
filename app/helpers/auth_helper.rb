...
module Sinatra
  module AuthHelper
    ...
    def validate_signup_params(params)
      errors = { 'f_name' => [], 'l_name' => [], 'email' => [],
                 'password' => [], 'confirm_password' => [] }
      values = {}
      options = { 'f_name' => 'First name', 'l_name' => 'Last name',
    ...
    def display_signup_values
      { 'f_name_v' => '', 'l_name_v' => '', 'email_v' => '',
        'password_v' => '', 'confirm_password_v' => '' }
    end

    def display_login_values
      { 'email_v' => '', 'password_v' => '', 'remember_v' => '' }
    end
